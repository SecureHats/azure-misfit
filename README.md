...
# SecureHats Azure Misfit

> This project is still under development and is used to create a vulnerable by design Azure environment including honeytokens etc.
